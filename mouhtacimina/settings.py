...
ALLOWED_HOSTS = ['*']  # Render fournit le domaine ; '*' OK pour démarrer  # Render fournit le domaine ; '*' OK pour démarrer
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mouhtacimina',
        'USER': 'postgres',
        'PASSWORD': os.environ.get('DB_PASSWORD', 'SangueBiDiop@7'),
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Mouhtacimina API',
    'DESCRIPTION': 'API de gestion du Dahira Mouhtacimina',
    'VERSION': '1.0.0',
}
